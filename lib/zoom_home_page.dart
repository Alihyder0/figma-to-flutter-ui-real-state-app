...
class _ZoomHomePageState extends State<ZoomHomePage> with TickerProviderStateMixin {
  ...
  zoomAndSlideContent(Widget content){
    ...
    return Transform(
        transform: Matrix4.translationValues(
            slideAmount,
            0.0,
            0.0)..scale(contentScale,contentScale),
...
class ZoomHomePageMenuController extends StatefulWidget {
  ...
  const ZoomHomePageMenuController({super.key, required this.builder});

  @override
  State<ZoomHomePageMenuController> createState() => _ZoomHomePageMenuControllerState();
}

class _ZoomHomePageMenuControllerState extends State<ZoomHomePageMenuController> {
  @override
  Widget build(BuildContext context) {
    return widget.builder(
      context , Provider.of<MenuProvider>(
        context,
        listen: true),
    );
  }
